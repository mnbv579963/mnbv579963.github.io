...
function show_answer_sp(i,k) {document.write('<iframe src="'+MEPath+'answer.php?itemid='+i+'&aid='+k+'" name="destoon_answer" id="des'+'toon_answer" class="iframec" scrolling="no" frameborder="0"></iframe>');}
